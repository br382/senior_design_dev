...
accX = accX * accel_mg_lsb;
accX = (accX / 1000);
accX = accX * GRAVITY;

accY = accY * accel_mg_lsb;
accY = (accY / 1000);
accY = accY * GRAVITY;

accZ = accZ * accel_mg_lsb;
accZ = (accZ / 1000);
accZ = accZ * GRAVITY;


//Serial.println(accX);Serial.print("\t");
//Serial.println(accY);Serial.print("\t");
//Serial.println(accZ);Serial.print("\t");
//  // print out accelleration data
//  Serial.print(F("Accel X: ")); Serial.print(accel.acceleration.x); Serial.print(" ");
//  Serial.print(F("  \tY: ")); Serial.print(accel.acceleration.y);       Serial.print(" ");
//  Serial.print(F("  \tZ: ")); Serial.print(accel.acceleration.z);     Serial.println("  \tm/s^2");
...
//
  ...
  */
  ...
  if (key_bool[ACC] == TRUE)
  {
    ...
    key_index.add(accY);
    key_index.add(accZ);
    key_index.add(kalAngleX);
    key_index.add(kalAngleY);
    key_bool[ACC] = FALSE;
    PRINT = TRUE;
  }
